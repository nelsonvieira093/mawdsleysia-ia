...
export default function Agent() {
  ...
  const [chatMessages, setChatMessages] = useState([
    {
      id: 1,
      sender: "agent",
      text: "Olá! Sou o Agente MAWDSLEYS. Como posso ajudar você hoje?",
    },
  ]);
  ...
  const handleStrategicQuery = () => {
    ...
    setTimeout(() => {
      const responses = {
        "quais são os riscos":
          "Identifiquei 5 riscos principais: 1) Dependência de fornecedor único 2) Conformidade regulatória 3) Flutuação cambial 4) Retenção de talentos 5) Cibersegurança. Recomendo ação imediata nos itens 2 e 5.",
        "crescimento do mercado":
          "O mercado apresenta crescimento de 12% ao ano. Nossa participação atual é de 8%, com potencial para 15% em 18 meses. Recomendo expansão nas regiões Sudeste e Sul.",
        "otimização de processos":
          "Analisei nossos processos principais. Identifiquei oportunidades de automação que podem reduzir custos em 25% e aumentar eficiência em 40%. Vou elaborar um plano detalhado.",
        "análise de concorrência":
          "Nossos principais concorrentes aumentaram investimento em inovação em 30%. Sugiro: 1) Aumentar R&D em 15% 2) Parcerias estratégicas 3) Diferenciação por serviço premium.",
        "tendências do setor":
          "Tendências atuais: 1) IA generativa 2) Sustentabilidade ESG 3) Trabalho remoto híbrido 4) Hiperautomação 5) Experiência do cliente omnichannel.",
      };

      const lowerQuery = query.toLowerCase();
      let response =
        "Entendi sua consulta. Com base na análise dos dados internos e tendências de mercado, recomendo:\n\n";

      if (lowerQuery.includes("risco")) {
        response = responses["quais são os riscos"];
      } else if (
        lowerQuery.includes("crescimento") ||
        lowerQuery.includes("mercado")
      ) {
        response = responses["crescimento do mercado"];
      } else if (
        lowerQuery.includes("processo") ||
        lowerQuery.includes("otimiz")
      ) {
        response = responses["otimização de processos"];
      } else if (
        lowerQuery.includes("concorrência") ||
        lowerQuery.includes("concorrente")
      ) {
        response = responses["análise de concorrência"];
      } else if (
        lowerQuery.includes("tendência") ||
        lowerQuery.includes("setor")
      ) {
    ...
    setTimeout(() => {
      const newAgenda = [
        ...
        },
        {
          ...
          day: "Segunda",
          time: "14:30",
          title: "Análise de métricas do último mês",
          participants: 4,
          priority: "alta",
        },
        {
        ...
        },
        {
          ...
          day: "Quinta",
          time: "09:30",
          title: "Treinamento de novas ferramentas",
          participants: 10,
          priority: "média",
        },
        {
  ...
  const generateAutoFollowUps = () => {
    ...
    setTimeout(() => {
      const newFollowUps = [
        {
          id: Date.now(),
          title: "Revisar KPIs do trimestre",
          priority: "alta",
          dueDate: "2025-12-08",
          responsible: "Gestor",
          status: "pendente",
        ...
        {
          id: Date.now() + 1,
          title: "Atualizar documentação de segurança",
          priority: "alta",
          dueDate: "2025-12-12",
          responsible: "TI",
          status: "pendente",
        ...
        {
          id: Date.now() + 2,
          title: "Preparar apresentação para board",
          priority: "média",
          dueDate: "2025-12-15",
        ...
        {
          id: Date.now() + 3,
          title: "Renovar licenças de software",
          priority: "média",
          dueDate: "2025-12-20",
          responsible: "Financeiro",
          status: "pendente",
  ...
  const quickActions = [
    {
      ...
      query: "Quais são os principais riscos que devemos considerar?",
    },
    {
      label: "Crescimento",
      query: "Como podemos acelerar nosso crescimento no mercado?",
    },
    {
      label: "Otimizar processos",
      query: "Quais processos podemos otimizar para reduzir custos?",
    },
    {
      label: "Tendências",
      query: "Quais as tendências mais importantes do nosso setor?",
    },
  ];
          ...
          <div className="header-left">
            ...
            <div className="agent-status">
              ...
              <span className="status-text">
                Online • Processando dados em tempo real
              </span>
            </div>
          </div>
          ...
          {activeTab === "dashboard" && (
            <div className="dashboard-grid">
              <div className="function-card">
                ...
                <p>
                  Extraia insights automáticos de PDFs, planilhas e
                  apresentações
                </p>
                <button
              ...
              <div className="function-card">
                ...
                <p>
                  Crie automaticamente acompanhamentos baseados em prazos e
                  prioridades
                </p>
                <button
                  className="function-btn"
                  onClick={generateAutoFollowUps}
                >
                  Gerar Automático
                </button>
              </div>
              ...
              <div className="function-card">
                ...
                <p>
                  Planeje reuniões semanais otimizadas com base nas necessidades
                </p>
              ...
              <div className="insights-card wide">
                ...
                <ul className="insights-list">
                  <li>
                    ⚠️ <strong>Atenção:</strong> 2 contratos com prazo de
                    renovação próximo
                  </li>
                  <li>
                    📈 <strong>Oportunidade:</strong> Redução de custos em 8%
                    possível
                  </li>
                  <li>
                    🎯 <strong>Meta:</strong> Crescimento de 15% alcançável no
                    próximo trimestre
                  </li>
                  <li>
                    🔄 <strong>Melhoria:</strong> Processo de aprovação pode ser
                    otimizado
                  </li>
                </ul>
              </div>
            ...
            <div className="documents-section">
              <div className="section-header">
                ...
                <div className="section-actions">
                  ...
                  {uploadedFile && (
                    <div className="uploaded-file">📄 {uploadedFile.name}</div>
                  )}
                </div>
              </div>
                ...
                {documents.map((doc) => (
                  <div key={doc.id} className="document-card">
                    ...
                    <div className="document-info">
                      ...
                      <span
                        className={`document-category ${doc.category.toLowerCase()}`}
                      >
                        {doc.category}
                      </span>
                    </div>
            ...
            <div className="followups-section">
              ...
              <div className="followups-grid">
                {followUps.map((followUp) => (
                  <div
                    key={followUp.id}
                    className={`followup-card priority-${followUp.priority}`}
                  >
            ...
            <div className="agenda-section">
              ...
              <div className="calendar-view">
                {["Segunda", "Terça", "Quarta", "Quinta", "Sexta"].map(
                  (day) => {
                    const dayEvents = weeklyAgenda.filter(
                      (event) => event.day === day
                    );
            ...
            <div className="chat-section">
              <div className="chat-container">
                ...
                <div className="chat-input-container">
                  <input
                    ...
                    onKeyPress={(e) =>
                      e.key === "Enter" && handleStrategicQuery()
                    }
              ...
              <div className="chat-sidebar">
                ...
                <ul className="suggested-queries">
                  <li
                    onClick={() =>
                      setQuery("Analise os riscos do próximo trimestre")
                    }
                  >
                    📊 Análise de riscos
                  </li>
                  <li
                    onClick={() =>
                      setQuery("Como otimizar nossos processos atuais?")
                    }
                  >
                    ⚡ Otimização de processos
                  </li>
                  <li
                    onClick={() =>
                      setQuery("Quais são as oportunidades de crescimento?")
                    }
                  >
                  ...
                  <li
                    onClick={() =>
                      setQuery("Analise a concorrência no mercado")
                    }
                  >
                  ...
                  <li
                    onClick={() =>
                      setQuery("Gere insights do último relatório financeiro")
                    }
                  >
