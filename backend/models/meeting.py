...
class Meeting(Base):
    ...
    # ⚠️ CORREÇÃO: Remova o back_populates (User não tem organized_meetings)
    organizer = relationship("User")  # SEM back_populates
...
class MeetingParticipant(Base):
    ...
    # ⚠️ CORREÇÃO: Remova o back_populates (User não tem meeting_participations)
    meeting = relationship("Meeting", back_populates="participants")
    user = relationship("User")  # SEM back_populates
